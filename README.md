...
### 1. 🌳 **bonsai2** — Frontend for Feed Generation
...
### 2. 📘 **bluesky-pds** — Personal Data Server with Embeddings
...
### 3. 🧩 **bluesky-feed-ruleset-generator** — Feed Ruleset Creation
...
**Key Point:** It does **not deploy feeds** — it only prepares the blueprint/ruleset for deployment.

---

### 4. 🚀 **bluesky-feed-manager** — Feed Deployment and Maintenance
...
[Natural Language Request / Bonsai2 UI]
      ↓
[bluesky-feed-ruleset-generator] → (feed ruleset + metadata)
      ↓
[bluesky-feed-manager] → (deploys feed dynamically)
      ↓
[Bluesky]

bluesky-pds → provides embeddings, author/post tables, and search API used by both ruleset-generator and feed-manager
```
